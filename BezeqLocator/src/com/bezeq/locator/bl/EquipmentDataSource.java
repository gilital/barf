...
//			}
	...
	private Bitmap getIcon(Constants.EquipmentTypes type) {
		...
		return (icon == null) ? icons.get(Constants.EquipmentTypes.CABINET) : icon;
	}

	protected void createIcons(Resources res) {
		if (res == null)
			throw new NullPointerException();
		icons.put(Constants.EquipmentTypes.MSAG, BitmapFactory.decodeResource(res, R.drawable.msag));
		icons.put(Constants.EquipmentTypes.DBOX, BitmapFactory.decodeResource(res, R.drawable.box));
		icons.put(Constants.EquipmentTypes.HOLE, BitmapFactory.decodeResource(res, R.drawable.pit));
		icons.put(Constants.EquipmentTypes.POLE, BitmapFactory.decodeResource(res, R.drawable.pole));
