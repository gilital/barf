...
public class Marker implements Comparable<Marker> {
	...
	public synchronized void set(String name, String comment, double latitude, double longitude, double altitude, int color) {
		...
		this.name = name;
		this.comment = (comment == null)?name:comment;
    ...
    protected synchronized void drawCollisionZone(Canvas canvas) {
        ...
        float currentAngle = PitchAzimuthCalculator.getAngle(symbolArray[0], symbolArray[1], textArray[0], textArray[1])+90;
    ...
    protected synchronized void drawIcon(Canvas canvas) {
        ...
        float currentAngle = PitchAzimuthCalculator.getAngle(symbolArray[0], symbolArray[1], textArray[0], textArray[1]);
